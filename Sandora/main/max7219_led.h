...
#define MAX7219_NUM_DEVICES 2  // Number of cascaded MAX7219 devices

esp_err_t max7219_init(void);
void max7219_clear(void);
void max7219_set_intensity(uint8_t intensity); // 0-15
void max7219_draw_row(uint8_t device, uint8_t row, uint8_t value);
void max7219_draw_matrix(uint8_t device, const uint8_t *data); // 8 bytes per device
