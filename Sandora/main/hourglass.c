...
// // // Buffer indexed as [y][x] for more intuitive access
// // static bool display_buffer[HEIGHT][TOTAL_WIDTH];
// // static unsigned long last_drop_time = 0;
...
// //     if (x == 0) return false; // Not available
// //     coord left = getLeft(x, y);
// //     return !display_buffer[left.y][left.x]; // Can go if empty
// // }
...
// //     if (y == HEIGHT - 1) return false; // Not available
// //     coord right = getRight(x, y);
// //     return !display_buffer[right.y][right.x]; // Can go if empty
// // }
...
// //     if (x == 0) return false; // Not available
// //     coord down = getDown(x, y);
// //     return !display_buffer[down.y][down.x]; // Can go if empty
// // }
...
// //     display_buffer[down.y][down.x] = true;
// // }
...
// //     coord left = getLeft(x, y);
// //     display_buffer[y][x] = false;
// //     display_buffer[left.y][left.x] = true;
// // }
...
// //     coord right = getRight(x, y);
// //     display_buffer[y][x] = false;
// //     display_buffer[right.y][right.x] = true;
// // }
...
// //         // Transfer from top module (right) to bottom module (left)
// //         // Connection point: bottom-left of top module (8,7) to top-right of bottom module (7,0)
// //         if (display_buffer[HEIGHT-1][WIDTH] && !display_buffer[0][WIDTH-1]) {
// //             display_buffer[HEIGHT-1][WIDTH] = false;
// //             display_buffer[0][WIDTH-1] = true;
// //             return true;
// //         }
// //     }
...
// //     for (int x = 0; x < TOTAL_WIDTH; x++)
// //         for (int y = 0; y < HEIGHT; y++)
// //             max7219_set_pixel(x, y, display_buffer[y][x]);
// //     max7219_update();
// // }
...
// //     // Fill the top module (right side) completely
// //     for (int y = 0; y < HEIGHT; y++) {
// //         for (int x = WIDTH; x < TOTAL_WIDTH; x++) {
// //             display_buffer[y][x] = true;
// //         }
...
// // Fill top module completely - FIXED
// static void fill_top() {
//     // Clear the entire display
//     memset(display_buffer, 0, sizeof(display_buffer));
    
//     // Fill the top module (right side) completely with diagonal pattern
//     fillModule(1, WIDTH * HEIGHT); // Module 1 is the top module, fill with all 64 particles
...
// === Global Timing Configuration ===
#define STABLE_FRAMES_THRESHOLD 30   // Frames to wait before flipping
#define FRAME_DELAY_MS 100           // Delay between frames
#define PARTICLE_DROP_DELAY_MS 1000  // Delay between particle drops
#define ANIMATION_PAUSE_MS 2000      // Pause between hourglass flips
...
// Fill a module completely (simple fill)
void fillModuleCompletely(int module) {
    int start_x = module * WIDTH;
    int end_x = start_x + WIDTH;
...
static void fill_top() {
    ...
    // Fill the top module (right side) completely
    fillModuleCompletely(1); // Module 1 is the top module
