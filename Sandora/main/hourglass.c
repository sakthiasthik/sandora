...
// // Check if particle can go down (diagonally)
// bool canGoDown(int x, int y) {
//     if (y == HEIGHT - 1) return false; // Not available
//     if (x == 0) return false; // Not available
//     coord down = getDown(x, y);
...
// // Update all particles in the display using diagonal traversal
// bool updateMatrix() {
//     bool somethingMoved = false;
//     int n = WIDTH;
    
//     // Create a copy of the current state to avoid interference
//     bool temp_buffer[TOTAL_WIDTH][HEIGHT];
//     memcpy(temp_buffer, display_buffer, sizeof(display_buffer));
...
//             // Process both modules
//             if (temp_buffer[x][y] && moveParticle(x, y)) {
//                 somethingMoved = true;
//             }
//             if (temp_buffer[x + WIDTH][y] && moveParticle(x + WIDTH, y)) {
//                 somethingMoved = true;
//             }
//         }
//     }
...
// Update all particles in the display using a more effective approach
bool updateMatrix() {
    bool somethingMoved = false;
    bool changed;
    
    // Multiple passes to ensure particles move as far as possible
    do {
        changed = false;
    ...
    } while (changed); // Continue until no more moves are possible
